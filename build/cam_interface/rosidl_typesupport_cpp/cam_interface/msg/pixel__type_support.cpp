...
static const _Pixel_type_support_symbol_names_t _Pixel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cam_interface, msg, Pixel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cam_interface, msg, Pixel)),
  }
};
...
{
  return &::cam_interface::msg::rosidl_typesupport_cpp::Pixel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cam_interface, msg, Pixel)() {
  return get_message_type_support_handle<cam_interface::msg::Pixel>();
}
