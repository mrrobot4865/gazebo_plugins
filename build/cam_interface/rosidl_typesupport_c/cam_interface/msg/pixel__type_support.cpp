...
static const _Pixel_type_support_symbol_names_t _Pixel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cam_interface, msg, Pixel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cam_interface, msg, Pixel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cam_interface, msg, Pixel)() {
  return &::cam_interface::msg::rosidl_typesupport_c::Pixel_message_type_support_handle;
}
