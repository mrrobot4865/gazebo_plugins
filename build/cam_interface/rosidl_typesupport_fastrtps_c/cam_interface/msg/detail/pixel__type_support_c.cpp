...
#include "cam_interface/msg/detail/pixel__rosidl_typesupport_fastrtps_c.h"
...
using _Pixel__ros_msg_type = cam_interface__msg__Pixel;
...
size_t get_serialized_size_cam_interface__msg__Pixel(
  const void * untyped_ros_message,
...
static uint32_t _Pixel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cam_interface__msg__Pixel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cam_interface
size_t max_serialized_size_cam_interface__msg__Pixel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Pixel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cam_interface__msg__Pixel(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cam_interface, msg, Pixel)() {
